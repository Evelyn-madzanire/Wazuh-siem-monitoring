# Wazuh SIEM Monitoring – Homelab Project
...
### **2. Configuration**
- Enabled security modules (FIM, Vulnerability Detection, etc.)
- Configured agent settings and log collection
- Tuned rules and alerts

### **3. Agent Deployment**
- Installed Wazuh agents on Windows and Linux machines
- Connected agents to the manager
- Verified agent status on the dashboard

### **4. Threat Detection**
- Tested File Integrity Monitoring (FIM)
- Generated test events (PowerShell activity, file changes, system logs)
- Observed alerts and reviewed event details

### **5. Log Analysis**
- Analyzed collected logs from endpoints
